...
We refer to the functions by the convension of C++ APIs if both C++ and Python APIs are provided, e.g., :cpp:func:`lm::init`. Some examples or APIs are specific either to C++ or Python. Those will be explicitly specified if necessary.
