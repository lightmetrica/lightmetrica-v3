...
void regCompWrap(pybind11::object implClass, const char* name) {
...
*/
template <typename InterfaceT>
pybind11::object createCompWrap(const char* name) {
...
#define PYLM_DEF_COMP_BIND(InterfaceT) \
    ...
    .def_static("create", &LM_NAMESPACE::py::createCompWrap<InterfaceT>)
